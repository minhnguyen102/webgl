// Bài 4. Sử dụng ma trận biến đổi, viết chương trình quay tam giác (hoặc 1 trong các hình
// vẽ trên) một góc 45 độ quanh Oz với điểm cố định là một đỉnh của tam giác.

// thực hiện xoay dựa trên đỉnh cố định là A(0, 0.5)
